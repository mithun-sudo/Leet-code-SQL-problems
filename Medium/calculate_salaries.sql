...
-- Insert statements for Salaries
...
when max_salary > 10000 then salary * 0.51 end, 0) as salary 
from
(select
*,
max(salary) over (partition by company_id order by salary desc) as max_salary
from
salaries) A
