...
select
stock_name,
sum(signed_price) as capital_gain_loss
from
(select 
*,
case when operation = 'Buy' then -1 * price else price end as signed_price
from
stocks) A
group by stock_name 
